    ...
    <div className="max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <h2 className="text-red-800 text-xl font-semibold mb-4">
        ...
        <form className='bg-white p-6 rounded-lg shadow-md'>
          ...
          <div className="mb-4">
            ...
            <input type="text" placeholder="+92" className="w-full border border-gray-300 p-2 rounded-md" />
          </div>
          <div className="mb-4">
            <label className="block mb-2 text-sm font-medium text-gray-700">
          ...
          <div className="mb-4">
            ...
            <input type="number" placeholder="Your Age" className="w-full border border-gray-300 p-2 rounded-md" />
          </div>
          <div className="mb-4">
            <label className="block mb-2 text-sm font-medium text-gray-700">
              Your current location <span className="text-red-600">*</span>
            </label>
            <input type="text" placeholder="Your current location" className="w-full border border-gray-300 p-2 rounded-md" />
          </div>
          <div className="mb-4">
            <label className="block mb-2 text-sm font-medium text-gray-700">
              Current Position <span className="text-red-600">*</span>
            </label>
            <input type="text" placeholder="Current Position" className="w-full border border-gray-300 p-2 rounded-md" />
          </div>
          {/* IELTS Dropdown */}
          <div className="mb-4">
            <label className="block mb-2 text-sm font-medium text-gray-700">
          ...
          text-white px-4 py-2  hover:bg-red-600 transition duration-300">
            Submit
          </button>
        </form>
      </div>
      ...
      <div>
        ...
        <ul className="list-disc list-inside mb-6 text-sm ">
          ...
          <li>If you are based in India IELTS 6.0 (in each band) needed, else IELTS not needed</li>
          <li>After completing diploma – apply and transfer to Public College programs (which allow PGWP) or get LMIA sponsored employment</li>
        </ul>
